...
const HostAnalytics = () => {
  ...
  if (!data || data.vehicleChartData?.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] opacity-30">
        <FaCarSide size={50} className="mb-4" />
        <p className="uppercase tracking-[0.5em] text-xs font-black">
    ...
    <div className=" space-y-10 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-[var(--card-bg)] p-6 rounded-2xl border border-[var(--primary)]/10 shadow-md car-card">
          <h3 className="text-[var(--primary)] text-sm font-black uppercase mb-6 tracking-widest">
        ...
        <div className="bg-[var(--card-bg)] p-8 rounded-2xl border border-[var(--primary)]/10 shadow-md lg:col-span-2 car-card">
          <h3 className="text-[var(--primary)] text-sm font-black uppercase mb-6 tracking-widest text-center">
