            ...
            <table className="table w-full border-collapse">
              ...
              <tbody className="divide-y divide-[var(--primary)]/5">
                {bookings.map((booking, index) => (
                  ...
                  >
                    <td className="px-6 py-5 font-mono text-xs opacity-80">
                      {index + 1}
                    </td>
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-bold text-[var(--text-main)] uppercase tracking-wide">
                            {booking.vehicleName}
                          </p>
                          <p className="text-[10px] opacity-40 font-mono italic">
                            ID: {booking.vehicleId?.slice(-6)}
                          </p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-5">
                      <p className="font-black text-[var(--primary)]">
                        $
                        {booking.totalPrice ||
                          booking.price * booking.totalDays}
                      </p>
                    </td>
