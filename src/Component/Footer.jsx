...
const Footer = () => {
  return (
    <footer className="bg-[#3D405B] dark:bg-[#2B2D42] text-[#F2CC8F] dark:text-[#F4F1DE] py-5 md:py-10 ">
      <div className="container px-4 mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
